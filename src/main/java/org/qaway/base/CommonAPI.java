...
public class CommonAPI {
    ...
    String implicitWait = prop.getProperty("implicit.wait", "20");
    ...
    public void setUp(@Optional("false") boolean useCloudEnv, @Optional("browserstack") String envName,
                      @Optional("https://www.google.com") String url, @Optional("LINUX") String os,
...
//    }
    ...
    public void switchToWindow(WebDriver driver,int nb){
        String tab = null;
    ...
    public String getTextAlert(){return driver.switchTo().alert().getText();}
    public boolean isSelected(WebElement element){
        return element.isSelected();
    }
    public void switchToParentFrame() {driver.switchTo().parentFrame();}
    public void actionsDragAndDrop(WebDriver driver1, WebElement element1,WebElement element2){
        Actions actions = new Actions(driver1);
    ...
    public void scrollIntoView(WebDriver driver1, WebElement element) {
